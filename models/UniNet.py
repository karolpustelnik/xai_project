...
class VisionTransformer(nn.Module):
    def __init__(self, repeats, expansion, channels, strides=[1, 2, 2, 2, 1, 2], num_classes=3, drop_path_rate=0.,
...
@register_model
def UniNetB0(num_classes, **kwargs): # 11.451M, 0.555G, 160
    repeats = [1, 2, 4, 4, 4, 8]
    ...
    model_kwargs = dict(repeats=repeats, expansion=expansion, channels=channels,
                        ...
                        input_size=input_size, num_classes = num_classes, **kwargs)
...
# model = UniNetB1(num_classes = 3)

# test_tensor = torch.randn(4, 1, 224, 224)
